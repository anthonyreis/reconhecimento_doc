...
cv.imwrite('imgGoverno.png', imgFrente[int(tam_governo_inicial):int(tam_governo_final), int(lateral_esquerda_governo):int(lateral_direita_governo)])
...
cv.imwrite('imgFoto.png', imgFrente[int(tam_centro_inicio):int(tam_centro_final), int(tam_foto_inicial):int(tam_foto_final)])
...
cv.imwrite('imgAssinatura.png', imgFrente[int(tam_assinatura_inicial):int(tam_assinatura_final), int(dist_lateral_esquerda):int(dist_lateral_direita)])

...
imgVerso = cv.imread('verso_rg.png')
...
cv.imwrite('imgRegistro.png', imgVerso[int(tam_registro_inicial):int(tam_registro_final), int(pos_inicial_registro):int(pos_final_registro)])
...
cv.imwrite('imgNome.png', imgVerso[int(tam_nome_inicial):int(tam_nome_final), int(pos_inicial_nome):int(pos_final_nome)])
...
cv.imwrite('imgFiliacao.png', imgVerso[int(tam_filiacao_inicial):int(tam_filiacao_final), int(pos_inicial_filiacao):int(pos_final_filiacao)])
...
cv.imwrite('imgNaturalidade.png', imgVerso[int(tam_naturalidade_inicial):int(tam_naturalidade_final), int(pos_inicial_naturalidade):int(pos_final_naturalidade)])
...
cv.imwrite('imgNaturalidade.png', imgVerso[int(tam_cpf_inicial):int(tam_cpf_final), int(pos_inicial_cpf):int(pos_final_cpf)])
...
cv.imwrite('imgNascimento.png', imgVerso[int(tam_nascimento_inicial):int(tam_nascimento_final), int(pos_inicial_nascimento):int(pos_final_nascimento)])
...
cv.imwrite('imgExpedicao.png', imgVerso[int(tam_expedicao_inicial):int(tam_expedicao_final), int(pos_inicial_expedicao):int(pos_final_expedicao)])
